...
@Tag(name = "Product Management", description = "Endpoints for managing the product catalog. "
                + "Read operations are public, while modifying operations require appropriate roles.")
// Server URL is configured via OpenApiConfig bean (forces "/" relative to gateway)
